...
class LineMesh(object):
    ...
    def add_line(self, vis, reset_bounding_box=True):
        """Adds this line to the visualizer"""
        for cylinder in self.cylinder_segments:
            vis.add_geometry(cylinder, reset_bounding_box)

    def remove_line(self, vis, reset_bounding_box=True):
        """Removes this line from the visualizer"""
        for cylinder in self.cylinder_segments:
            vis.remove_geometry(cylinder, reset_bounding_box)
